							...
							<div class="service-overview__item-text">
								<div class="service-overview__title-wrap">
									<div class="service-overview__counter">
										<div
											class="service-overview__serial subtitle"
										>
											{String(index + 1).padStart(2, '0')} /
											{String(
												slice.primary.service_items
													.length
											).padStart(2, '0')}
										</div>
									</div>
									<h4 class="service-overview__item-title">
										{item.service_title}
									</h4>
								</div>
								<div
									class="service-overview__item-description rich-text-content"
								>
									<PrismicRichText
