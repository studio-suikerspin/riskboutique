...
<section data-slice-type={slice.slice_type} data-slice-variation={slice.variation} class="feature-cards block-padding">
				...
				<div class="swiper-wrapper">
					...
					<div class="swiper-slide">
						<div class="slide-content">
							<FeatureCard title={item.title} description={item.description} background={item.background_color} text_color={item.text_color} number={item.index} shape={item.shape} />
						</div>
					</div>
					{/each}
				</div>
